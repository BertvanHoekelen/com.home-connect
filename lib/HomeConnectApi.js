	...
	*/
	...
	enableEvents( haId ) {
		return new Promise((resolve, reject) => {
			...
			if( this._events[ haId ] )
				throw new Error('Events are already enabled');

			console.log(`${this._apiUrl}/homeappliances/${haId}/events`, {
				headers: {
	...
	disableEvents( haId ) {
		...
		if( typeof this._events[ haId ] === 'undefined' )
			throw new Error('Events are not yet enabled');
